...
class TestImage(TestCase):
    def setUp(self):
        self.location = Location(name='Runda')
    ...
    def test_update_image(self):
        self.image_test.save_image()
        self.image_test.update_image(self.image_test.id, 'media/images/work2.jpg')
        changed_img = Image.objects.filter(image='media/images/work2.jpg')
    ...
    def test_search_image_by_location(self):
        self.image_test.save_image()
        found_images = self.image_test.filter_by_location(location='Ruiru')
...
class TestLocation(TestCase):
    def setUp(self):
        self.location = Location(name='Rongai')
        self.location.save_location()
    ...
    def test_update_location(self):
        ...
        changed_location = Location.objects.filter(name='Rongai')
...
class CategoryTestClass(TestCase):
    def setUp(self):
        self.category = Category(name='Rongai')
        self.category.save_category()
